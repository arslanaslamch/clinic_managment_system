			...
			<div class="box-body">
				  <div class="form-group">
					<div class="col-md-6 form-group">
					  ...
					  <input type="text" name="patient_fname" required class="form-control" placeholder="(e.g Arslan)">
					</div>
					<div class="col-md-6 form-group">
					  <label> Patient Last Name </label>
					  <input type="text" name="patient_lname" required class="form-control" placeholder="(e.g Aslam)">
					</div>
				  </div>
				  <div class="form-group">
					<div class="col-md-6 form-group">
					  <label> Mobile Number 1 </label>
					  <input type="text" name="mob_no_one" required class="form-control" placeholder="(e.g 03265894565)">
					</div>
					<div class="col-md-6 form-group">
					  <label> Mobile Number 2 </label>
					  <input type="text" name="mob_no_two" required class="form-control" placeholder="(e.g 03265894565)">
					</div>
				  </div>
				  <br />
				  <div class="form-group">
					...
					<div class="col-md-6 form-group">
					  <label> Select Appointment Date </label>
					    <div class="input-group date">
						  ...
						  <input type="text" required name="appointment_date" class="form-control pull-right" id="datepicker">
						</div>
					</div>
				  </div>
				  <br />
					...
					<div class="col-md-6 form-group">
					  <label> Date Of Birth </label>
						<div class="input-group">
						  ...
						  <input type="text" required name="date_of_birth" class="form-control" data-inputmask="'alias': 'mm/dd/yyyy'" data-mask="">
						</div>
					</div>
					<div class="col-md-6 form-group">
