...
<?php
	if(isset($_GET['edit'])){
		...
		$EditPatientData = mysqli_query($ClassDB, "SELECT * FROM `patient` WHERE `id`='$EditPatient'");
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add New Paitent File</li>
      </ol>
    </section>
	<br />
	<div class="form-group" style="padding-left: 14px;">
		<a href="Add-exsisting-patient.php"><button type="button" class="btn btn-block btn-warning" style="width: 150px; display: inline;">Existing Patient File</button></a> &nbsp;&nbsp;&nbsp; <a href="#"><button type="button" class="btn btn-block btn-primary" style="width: 150px; display: inline;">Add New Paitent File</button></a>
	</div>
    <!-- Main content -->
			...
			<div class="box-body">
					...
					<div class="col-md-6 form-group">
					  <label> Select Appointment Date </label>
					    <div class="input-group date">
						  ...
						  <input type="text" required name="appointment_date" value="<?php echo $EPD['appointment_date']; ?>" class="form-control pull-right" id="datepicker">
						</div>
					</div>
				  </div>
				  <br />
				  <div class="col-md-12 form-group" style="padding-left: 0px; padding-right: 0px;">
					...
					<div class="col-md-6 form-group">
					  ...
					  <option value=""> Select Doctor  </option>
							...
							?>
								<option <?php if($EPD['doctor_name'] == $GD['Doctor_id']){ echo "selected"; } ?> value="<?php echo $GD['Doctor_id']; ?>"> <?php echo $GD['Doctor_fname']; ?> <?php echo $GD['Doctor_lname']; ?> </option>
							<?php
								}
							?>
					  </select>
				  ...
				  <div class="col-md-12 form-group" style="padding-left: 0px; padding-right: 0px;">
					<div class="col-md-6 form-group">
						  ...
						  <option id="alreadySelected" value="<?php echo $EPD['select_session']; ?>"> 
						  <?php $Sname = $EPD['select_session']; $getSession = mysqli_query($ClassDB, "SELECT * FROM `doctors_sessions` WHERE `session_id`='$Sname'"); $SNS = mysqli_fetch_assoc($getSession); echo $SNS['session_day'].' - '.$SNS['session_time']; ?> 
						  </option>
					...
					<div class="col-md-6 form-group">
					  <label> Appointment Time </label>
						<div class="input-group">
							<input type="text" required name="appointment_time" value="<?php echo $EPD['appointment_time']; ?>" class="form-control timepicker">
				  ...
				  <div class="form-group">
					<div class="col-md-6 form-group">
						...
						<input type="number" name="payment_amount" value="<?php echo $EPD['payment_amount']; ?>" required class="form-control" placeholder="(e.g 200)">
					</div>
					<div class="col-md-6 form-group">
					  <label> Status </label>
					  <select class="form-control select2" name="payment_status" data-placeholder="Select Week Days" style="width: 100%;">
							<option <?php if($EPD['status'] == 'Booked'){ echo 'selected'; } ?> value="Booked"> Booked </option>
							<option <?php if($EPD['status'] == 'Paid'){ echo 'selected'; } ?> value="Paid"> Paid </option>
							<option <?php if($EPD['status'] == 'No Show'){ echo 'selected'; } ?> value="No Show"> No Show </option>
							<option <?php if($EPD['status'] == 'Follow Up'){ echo 'selected'; } ?> value="Follow Up"> Follow Up </option>
					  </select>
					</div>
				  </div>
