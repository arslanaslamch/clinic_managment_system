	...
	<div class="form-group">
			...
			<?php
				if(isset($_GET['noshow'])){
					$NoShow = $_GET['noshow'];
					$UpdateNoShow = mysqli_query($ClassDB, "UPDATE `paitent_tests` SET `status`='No Show' WHERE `id`='$NoShow'");
					if($UpdateNoShow){
						echo '
							<div class="alert alert-success alert-dismissible" role="alert">
							  <strong>Congratulations!</strong> Payment Status Updated To No Show Successfully.
							  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							  </button>
							</div>
			...
			<?php
				if(isset($_GET['followup'])){
					...
					$UpdateFollow = mysqli_query($ClassDB, "UPDATE `paitent_tests` SET `status`='Follow Up' WHERE `id`='$followup'");
					if($UpdateFollow){
						echo '
							<div class="alert alert-success alert-dismissible" role="alert">
							  <strong>Congratulations!</strong> Payment Status Updated To Follow Up Successfully.
							  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							  </button>
							</div>
			...
			<?php
				if(isset($_GET['delete'])){
					$DeleteTST = $_GET['delete'];
					$DeleteTEST = mysqli_query($ClassDB, "DELETE FROM `paitent_tests` WHERE `id`='$DeleteTST'");
					if($DeleteTEST){
						echo '
							<div class="alert alert-success alert-dismissible" role="alert">
							  <strong>Congratulations!</strong> This Test Has Been Deleted Successfully.
							  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							  </button>
							</div>
						...
						echo '
							<div class="alert alert-danger alert-dismissible" role="alert">
							  <strong>Ooops!</strong> This Test Has Not Been Deleted. Please Try Again
							  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							  </button>
							</div>
		...
		<div class="box-body">
             <table id="example1" class="table table-bordered table-striped" style="width: 1700px;">
                ...
                <tr>
                  ...
                  <td><a href="view-patient-tests.php?view=<?php echo $GD['id']; ?>"><i class="fa fa-print"></i></a>&nbsp;&nbsp;<a href="?delete=<?php echo $GD['id']; ?>" onclick="return confirm('Are you really want to detele this Test? You will not able to undo this and this will also deleted from the expense sheet')"><i class="fa fa-trash"></i></a>&nbsp;&nbsp;
				  ...
				  <td>
					<div class="btn-group">
						  ...
						  <ul class="dropdown-menu" role="menu">
							...
							<li><a <?php if($GD['status'] == 'No Show'){ echo "style='display: none;'"; } ?> href="?noshow=<?php echo $GD['id']; ?>">No Show</a></li>
							<li><a <?php if($GD['status'] == 'Follow Up'){ echo "style='display: none;'"; } ?> href="?followup=<?php echo $GD['id']; ?>">Follow Up</a></li>
						  </ul>
						</div>
					</div>
                </tr>
