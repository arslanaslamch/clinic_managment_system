	...
	<div class="form-group">
			...
			<?php
				if(isset($_GET['noshow'])){
					$NoShow = $_GET['noshow'];
					$UpdateNoShow = mysqli_query($ClassDB, "UPDATE `patient` SET `status`='No Show' WHERE `id`='$NoShow'");
					if($UpdateNoShow){
						echo '
							<div class="alert alert-success alert-dismissible" role="alert">
			...
			<?php
				if(isset($_GET['followup'])){
					...
					$UpdateFollow = mysqli_query($ClassDB, "UPDATE `patient` SET `status`='Follow Up' WHERE `id`='$followup'");
					if($UpdateFollow){
						echo '
							<div class="alert alert-success alert-dismissible" role="alert">
			...
			<?php
				if(isset($_GET['delete'])){
					$DeletePatient = $_GET['delete'];
					$DeletePatientRecord = mysqli_query($ClassDB, "DELETE FROM `patient` WHERE `id`='$DeletePatient'");
					if($DeletePatientRecord){
						echo '
							<div class="alert alert-success alert-dismissible" role="alert">
							  <strong>Congratulations!</strong> This Patient Has Been Deleted Successfully.
							  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							  </button>
							</div>
						...
						echo '
							<div class="alert alert-danger alert-dismissible" role="alert">
							  <strong>Ooops!</strong> This Patient Has Not Been Deleted. Please Try Again
							  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							  </button>
							</div>
                  ...
                  <td>
						<div class="btn-group">
						  ...
						  <ul class="dropdown-menu" role="menu">
							...
							<li><a <?php if($GP['status'] == 'No Show'){ echo "style='display: none;'"; } ?> href="?noshow=<?php echo $GP['id']; ?>">No Show</a></li>
							<li><a <?php if($GP['status'] == 'Follow Up'){ echo "style='display: none;'"; } ?> href="?followup=<?php echo $GP['id']; ?>">Follow Up</a></li>
						  </ul>
						</div>
				  </td>
				  <td>
						<a href="edit-patient.php?edit=<?php echo $GP['id']; ?>"><i class="fa fa-pencil"></i></a> &nbsp;&nbsp; <a href="?delete=<?php echo $GP['id']; ?>" onclick="return confirm('Are you really want to detele this patient? You will not able to undo this.')"><i class="fa fa-trash"></i></a>
				  </td>
                </tr>
				<?php } ?>
				</tbody>
